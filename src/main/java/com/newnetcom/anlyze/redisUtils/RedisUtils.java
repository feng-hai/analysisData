package com.newnetcom.anlyze.redisUtils;
...
public class RedisUtils {
	...
	private static final String ip = PropertyResource.getInstance().getProperties().get("redisAddress");//"10.60.60.96";
	private static final Integer port =Integer.parseInt( PropertyResource.getInstance().getProperties().get("redisPort"));;
