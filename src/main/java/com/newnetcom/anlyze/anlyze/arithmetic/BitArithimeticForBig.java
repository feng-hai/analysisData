...
//			String bitStr = ByteUtils.byte2bitsByIndex(tByte, (byte)(7-bitIndex-bean.getLength()), (byte) bean.getLength());
//			if (!isNum) {
//				int num = ByteUtils.getNum(bean.getResolving());
...
//			String bitResult = bitStr.substring(byteLength * 8-1-bitIndex, bitIndex + bean.getLength());
//			if (!isNum) {
//				float resolving = Float.parseFloat(bean.getResolving());
//				int num = ByteUtils.getNum(bean.getResolving());
//				if (byteLength <= 4) {
