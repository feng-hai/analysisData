...
/**
 * HBase 各个组件管理调用�?
 * 可以根据配置文件来�?�择  HBase 官方 API 还是第三方API
...
//    }
    ...
    static {
        // TODO  根据配置文件来�?�择  HBase 官方 API 还是第三方API
        hBaseService = new HBaseServiceImpl();
//        hBaseService = new AsyncHBaseServiceImpl();
    }
    public static void  batchAsyncPut(String tableName,List<Put> puts, boolean waiting)
    {
    	hBaseService.batchAsyncPut(tableName, puts, waiting);
    }
